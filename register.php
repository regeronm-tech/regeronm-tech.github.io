<?php
session_start();
// ถ้า Logged-in แล้ว ไม่ให้เข้าหน้านี้
...
$register_success = ''; // เก็บข้อความสำเร็จ
$register_error = '';   // เก็บข้อความ error
...
<head>
    ...
    <style>
        /* ป้องกัน dropdown ของ Swal ถ้าโดน CSS nice-select แทรก */
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav  mx-auto ">
                            <li class="nav-item">
                                <a class="nav-link need-login" href="index.php">Home <span
                                        class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link need-login" href="menu.php">Menu</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link need-login" href="about.php">About</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link need-login" href="book.php">About Me</a>
                            </li>
                        </ul>
                        <div class="user_option">
                            <a class="order_online need-login" href="order.php">
                                Order Online
                            </a>
                        </div>
                    </div>
    ...
    <section class="book_section layout_padding">
        <div class="container">
            ...
            <div class="heading_container heading_center">
                <h2 style="color: #000000;">Register</h2>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                ">
                        ...
                        <form action="register.php" method="POST">
                            ...
                            <div class="btn_box mt-4 text-center">
